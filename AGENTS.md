...
4. 人間による承認後、実装を開始する
5. 実装完了後、 `pnpm run build` コマンドを実行し、ビルドが通ることの確認と開発者が動作確認をしやすい環境を用意すること
6. ビルドが通った後、featureブランチをリモートにPushし、mainブランチに向けて適切なOverviewを記載したPRを作成する
7. PR提出後、人間からの承認を得られた場合は、worktreeを削除して最新のmainブランチにcheckoutすること
