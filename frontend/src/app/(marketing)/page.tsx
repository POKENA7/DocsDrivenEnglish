    ...
    <main className="container-page py-16">
      <div className="reveal">
        ...
        <p className="mt-4 max-w-prose text-sm leading-relaxed text-muted-foreground [word-break:auto-phrase]">
          「React Hooks」「Kubernetes
          Pod」など、気になる技術トピックを入力するだけ。AIが本物の技術ドキュメントさながらの英語クイズをその場で生成します。毎日続けて、技術英語をサクッとモノにしよう。
        </p>
      ...
      <section className="mt-10 grid gap-3 sm:grid-cols-3">
        <div className="card-compact reveal" style={{ animationDelay: "80ms" }}>
          ...
          <p className="mt-2 text-sm text-muted-foreground [word-break:auto-phrase]">
        ...
        <div className="card-compact reveal" style={{ animationDelay: "160ms" }}>
          ...
          <p className="mt-2 text-sm text-muted-foreground [word-break:auto-phrase]">
            word /
            readingの2モード＆最大20問から自由にカスタマイズ。他のユーザーのクイズにも挑戦できます。
          </p>
        </div>
